...
public class index extends AppCompatActivity
    ...
    public boolean onNavigationItemSelected(MenuItem item) {
        ...
        if (id == R.id.nav_camera) {
            ...
            fragmentManager.beginTransaction().replace(R.id.contenedor,new menu3()).commit();

        } else if (id == R.id.nav_manage) {

            fragmentManager.beginTransaction().replace(R.id.contenedor,new menu4()).commit();
            ...
            Intent restartHome = new Intent(index.this, loginj.class);
